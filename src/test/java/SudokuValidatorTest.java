...
public class SudokuValidatorTest {
    ...
    @Test
    public void validateRowSizeTest(){
        final int[][] input = {
                {6, 2, 4, 5, 3, 9, 10, 8},
                {5, 6, 9, 7, 2, 8, 1, 3, 4},
                {8, 3, 7, 6, 1, 4, 2, 9, 5},
        ...
        final String message = new SudokuValidator(input).validate();
        Assertions.assertEquals("Incorrect row size 8",message);
    }

    @Test
    public void validateColumnSizeTest(){
        final int[][] input = {
                {6, 2, 4, 5, 3, 9, 10, 8},
                {5, 6, 9, 7, 2, 8, 1, 3, 4},
                {8, 3, 7, 6, 1, 4, 2, 9, 5},
        ...
        final String message = new SudokuValidator(input).validate();
        Assertions.assertEquals("Incorrect column size 8 for column 0",message);
    }
    ...
    public void valueValidationTest(){
        ...
        final String message = new SudokuValidator(input).validate();
        Assertions.assertEquals("Cell(0,6) has a invalid value 10",message);
    }
    ...
    public void validateColumnDupsTest(){
        ...
        final String message = new SudokuValidator(input).validate();
        Assertions.assertEquals("Cell(1,6) has a duplicate value for COLUMN (6)",message);
    }
    ...
    public void inValidInput2Test(){
        ...
        final String message = new SudokuValidator(input).validate();
        Assertions.assertEquals("Cell(3,2) has a invalid value 0",message);
    }
